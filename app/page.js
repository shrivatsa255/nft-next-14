            ...
            <div className="flex flex-row w-max overflow-x-scroll no-scrollbar select-none" ref={scrollRef}>
              ...
              {!hideButtons && (
                <>
                  ...
                  >
                    <Image src={img.left} width={2} height={2}  alt="leftarrow" className={theme === 'light' ? 'filter invert' : undefined} />
                  </div>
                  <div
                    onClick={() => {
                      handelScroll('right');
                  ...
                  >
                    <Image src={img.right} width={2} height={2}  alt="rightarrow" className={theme === 'light' ? 'filter invert' : undefined} />
                  </div>
                </>
              )}
            </div>
